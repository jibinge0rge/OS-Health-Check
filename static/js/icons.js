// Minimal inline Lucide-style glyph set (no CDN dependency, no build step).
// Product icons (os-family, publish, edit, retry, add, download, ai,
// navbar-discover) are separate flat SVG files under /static/icons/.
...
const PATHS = {
  ...
  "rotate-ccw": '<path d="M3 12a9 9 0 1 0 2.64-6.36L3 8"/><polyline points="3 3 3 8 8 8"/>',
